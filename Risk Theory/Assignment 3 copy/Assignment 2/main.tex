...
The Makeham distribution therefore does not account for the infant deaths that pull the sample mean down.
...
\begin{verbatim}
makeham_cond <- 
    integrate(sMakeham, 65, Inf, a.hat, b.hat, c.hat)$value / sMakeham(65, a.hat, b.hat, c.hat)
